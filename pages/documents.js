                                ...
                                <div className="section-heading">
                                    ...
                                    <p className="section__desc">
                                        <ul className="icon">
                                            ...
                                            <li className="star"><a href="https://api.iseser.com/doc/2023/ISESER2023_BANNER.pdf?v1" target="_blank"><i className="fa  fa-file-pdf-o"></i> BANNER</a></li>
                                        ...
                                        <hr/>
                                        <ul>
                                            <li className="star"><a href="https://api.iseser.com/doc/2023/ISESER2023_Abstract_Template.docx" target="_blank"><i className="fa fa-file-word-o"></i> Abstract Template</a>
                                            </li>
                                            <li className="star"><a href="https://api.iseser.com/doc/2023/ISESER2023_Full_Paper_Template.docx" target="_blank"><i className="fa fa-file-word-o"></i> Full Paper Template</a>
                                            </li>
                                            <li className="star"><a href="https://api.iseser.com/doc/2023/ISESER2023_POSTER-PREPARATION.pptm" target="_blank"><i className="fa fa-file-powerpoint-o"></i> Poster
                                                Template</a></li>
