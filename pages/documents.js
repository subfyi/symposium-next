...
const AboutPage = () => {
    return (
        <Layout pageTitle="Documents | ISESER2022">
            <NavOne/>
                        ...
                        <div className="col-lg-12">
                            <div className="about-heading">
                                <div className="section-heading">
                                    <h2 className="section__title">Documents for 2022
                                    </h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="about-heading">
                                <div className="section-heading">
                                    ...
                                    <p className="section__desc">
                                        ...
                                        <hr/>
                                        <ul>
                                            <li className="star"><a href="../doc/2022/ISESER2022_Abstract_Template.docx" target="_blank"><i className="fa fa-file-word-o"></i> Abstract Template</a>
                                            </li>
                                            <li className="star"><a href="../doc/2022/ISESER2022_Full_Paper_Template.docx" target="_blank"><i className="fa fa-file-word-o"></i> Full Paper Template</a>
                                            </li>
                                            <li className="star"><a href="../doc/2022/ISESER2022_POSTER-PREPARATION.pptm" target="_blank"><i className="fa fa-file-powerpoint-o"></i> Poster
                                                Template</a></li>
