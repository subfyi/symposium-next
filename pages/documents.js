                ...
                <div className='section-heading'>
                  ...
                  <p className='section__desc'>
                    <ul className='icon'>
                      ...
                      <li className='star'><a href='https://api.iseser.com/doc/2023/ISESER2023-PROGRAM-PRELIMINARY.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PRELIMINARY PROGRAM</a></li>
                      ...
                      {/*
                        <li className="star"><a href="https://api.iseser.com/doc/2023/ISESER2023_BROCHURE.pdf?e10" target="_blank"><i className="fa  fa-file-pdf-o"></i> BROCHURE</a></li>
                        <li className='star'><a href='../doc/2023/ISESER2023-FINAL-PROGRAM.pdf?e10'  target='_blank' rel='noopener noreferrer'><i  className='fa  fa-file-pdf-o'></i> FINAL PROGRAM </a></li>
