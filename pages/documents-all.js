                ...
                <div className='section-heading'>
                  ...
                  <div className='section__desc'>
                    <ul className='icon'>
                      ...
                      <li className='star'><a href='https://api.iseser.com/doc/2023/ISESER2023-PROGRAM-PRELIMINARY.pdf?e5' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PRELIMINARY PROGRAM</a></li>
                      <li className='star'>
