              ...
              <div>
                <div className='section-heading'>
                  ...
                  <div className='section__desc'>
                    <ul className='icon'>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2021/ISESER2021_BANNER.pdf?e10' target='_blank'><i className='fa  fa-file-pdf-o'></i> BANNER</a></li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2021/ISESER2021_BROCHURE.pdf?e10' target='_blank'><i className='fa  fa-file-pdf-o'></i> BROCHURE</a></li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2021/ISESER2021-FINAL-PROGRAM.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> FINAL PROGRAM </a>
                      </li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2021/ISESER2021-ABSTRACT-BOOK.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> ABSTRACT BOOK </a>
                      </li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2021/ISESER2021-PROCEEDING-BOOK.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PROCEEDING BOOK
                        </a>
                      </li>
                      <li className='star'>
                ...
                <div className='section-heading'>
                  ...
                  <div className='section__desc'>
                    <ul className='icon'>
                      ...
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2020/ISESER2020-FINAL-PROGRAM.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> FINAL PROGRAM </a>
                      </li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2020/ISESER2020-ABSTRACT-BOOK.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> ABSTRACT BOOK </a>
                      </li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2020/ISESER2020-PROCEEDING-BOOK.pdf?e10' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PROCEEDING BOOK
                        </a></li>
                      <li className='star'>
                ...
                <div className='section-heading'>
                  ...
                  <div className='section__desc'>
                    <ul className='icon'>
                      ...
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2019/ISESER2019-FINAL-PROGRAM.pdf?e100' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> FINAL PROGRAM </a>
                      </li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2019/ISESER2019-ABSTRACT-BOOK.pdf?e100' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> ABSTRACT BOOK </a>
                      </li>
                      <li className='star'>
                        <a href='https://api.iseser.com/doc/2019/ISESER2019-PROCEEDING-BOOK.pdf?e100' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PROCEEDING BOOK
                        </a></li>
                      <li className='star'>
