                                ...
                                <div className="section-heading">
                                    ...
                                    <p className="section__desc">
                                        <ul className="icon">
                                            ...
                                            <li className="star"><a href="../../doc/2021/ISESER2021-PROCEEDING-BOOK.pdf?e1" target="_blank" rel="noopener noreferrer"><i className="fa  fa-file-pdf-o"></i> PROCEEDING BOOK (preliminary)</a></li>
