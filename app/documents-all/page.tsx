                            ...
                            <div className='section-heading'>
                                ...
                                <div className='section__desc'>
                                    <ul className='icon'>
                                        ...
                                        <li className='star'>
                                            <a href='https://api.iseser.com/doc/2020/ISESER2020-FINAL-PROGRAM.pdf' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> FINAL PROGRAM </a>
                                        </li>
                                        <li className='star'>
                                            <a href='https://api.iseser.com/doc/2020/ISESER2020-ABSTRACT-BOOK.pdf' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> ABSTRACT BOOK </a>
                                        </li>
                                        <li className='star'>
                                            <a href='https://api.iseser.com/doc/2020/ISESER2020-PROCEEDING-BOOK.pdf' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PROCEEDING BOOK
                                            </a></li>
                                        <li className='star'>
                            ...
                            <div className='section-heading'>
                                ...
                                <div className='section__desc'>
                                    <ul className='icon'>
                                        ...
                                        <li className='star'>
                                            <a href='https://api.iseser.com/doc/2019/ISESER2019-FINAL-PROGRAM.pdf' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> FINAL PROGRAM </a>
                                        </li>
                                        <li className='star'>
                                            <a href='https://api.iseser.com/doc/2019/ISESER2019-ABSTRACT-BOOK.pdf' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> ABSTRACT BOOK </a>
                                        </li>
                                        <li className='star'>
                                            <a href='https://api.iseser.com/doc/2019/ISESER2019-PROCEEDING-BOOK.pdf' target='_blank' rel='noopener noreferrer'><i className='fa  fa-file-pdf-o'></i> PROCEEDING BOOK
                                            </a></li>
