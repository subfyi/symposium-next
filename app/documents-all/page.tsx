            ...
            <div className='section-heading'>
              ...
              <div className='section__desc'>
                ...
                <ul>
                  ...
                  <li><a href='https://www.youtube.com/playlist?list=PLcT5bWlEGP-2fKrCEWPUJ4vDa7Rd0e4n1' target='_blank' rel='noopener noreferrer'><i className='fa fa-youtube' aria-hidden='true'></i> VIDEOS </a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div className='section-heading'>
                ...
                <div className='section__desc'>
                  ...
                  <ul>
                    ...
                    <li><a href='https://www.youtube.com/playlist?list=PLcT5bWlEGP-2aj8W_R1lqzQYYDZW3W8Bs' target='_blank' rel='noopener noreferrer'><i className='fa fa-youtube' aria-hidden='true'></i> VIDEOS </a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className='section-heading'>
                ...
                <div className='section__desc'>
                  ...
                  <ul>
                    ...
                    <li><a href='https://www.youtube.com/playlist?list=PLcT5bWlEGP-1MCb7MnCW_ppwGCLF_cz3w' target='_blank' rel='noopener noreferrer'><i className='fa fa-youtube' aria-hidden='true'></i> VIDEOS </a></li>
                  </ul>
                </div>
              </div>
            </div>
