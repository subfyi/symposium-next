...
export default async function Page(
  ...
  var [orals, posters] = await Promise.all([
    api('/api/submission?page=1&itemPerPage=-1&sort=id&desc=false&orals=1&year=' + params?.id),
    api('/api/submission?page=1&itemPerPage=-1&&sort=id&desc=false&posters=1&year=' + params?.id)
  ])
