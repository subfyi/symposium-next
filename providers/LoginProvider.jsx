		...
		<ValidatorProvider>
			<Form onSubmit={onLogin}>
				...
				<ModalFooter>
					...
					<Button type="button" block outline color="primary" disabled={!!loading} onClick={_ => setLogin(2)}>
						Register an account
					</Button>
					
					<Button type="button" block outline color="primary" disabled={!!loading} onClick={_ => setLogin(3)}>
						Forgot password
					</Button>
				</ModalFooter>
			</Form>
