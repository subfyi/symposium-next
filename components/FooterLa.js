...
class FooterLa extends Component {
  constructor() {
    super()
    this.state = {
      scrollBtn: false
            ...
            <div className='container'>
              <div className='row footer-widget-wrap'>
                <div className='col footer-item footer-item1  col-md-4'>
                  <aside><a href='/'>
                    <img className='td-retina-data td-retina-version' src='https://iseser.com/doc/logo/v_5_telif-300x300.png' alt='iseser' title='iseser' width='' /></a>
                  </aside>
                </div>
